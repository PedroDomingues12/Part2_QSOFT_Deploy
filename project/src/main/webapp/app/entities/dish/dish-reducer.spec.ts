...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './dish.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISH_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DISH actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DISH actions', async () => {
      const arg = { id: 26541 };
    ...
    it('dispatches UPDATE_DISH actions', async () => {
      const arg = { id: 26541 };
    ...
    it('dispatches PARTIAL_UPDATE_DISH actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DISH actions', async () => {
      const arg = 42666;
