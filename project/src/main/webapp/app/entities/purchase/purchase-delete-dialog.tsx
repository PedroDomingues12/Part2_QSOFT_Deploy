...
import { deleteEntity, getEntity } from './purchase.reducer';

export const PurchaseDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate(`/purchase${pageLocation.search}`);
  };
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(purchaseEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="smartdineApp.purchase.delete.question">
        <Translate contentKey="smartdineApp.purchase.delete.question" interpolate={{ id: purchaseEntity.id }}>
