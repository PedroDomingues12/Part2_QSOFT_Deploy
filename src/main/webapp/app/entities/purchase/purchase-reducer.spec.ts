...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './purchase.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PURCHASE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PURCHASE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PURCHASE actions', async () => {
      const arg = { id: 8022 };
    ...
    it('dispatches UPDATE_PURCHASE actions', async () => {
      const arg = { id: 8022 };
    ...
    it('dispatches PARTIAL_UPDATE_PURCHASE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PURCHASE actions', async () => {
      const arg = 42666;
