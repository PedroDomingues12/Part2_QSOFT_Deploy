...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MENUDISHES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MENUDISHES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MENUDISHES actions', async () => {
      const arg = { id: 886 };
    ...
    it('dispatches UPDATE_MENUDISHES actions', async () => {
      const arg = { id: 886 };
    ...
    it('dispatches PARTIAL_UPDATE_MENUDISHES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MENUDISHES actions', async () => {
      const arg = 42666;
